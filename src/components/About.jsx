    ...
    >
      <div className="container-page grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <p className="mt-5 max-w-prose text-base leading-relaxed text-ink-600 dark:text-ink-300">
            {site.bio}
          </p>
          <p className="mt-5 flex items-center gap-2 text-sm text-ink-500 dark:text-ink-400">
